/**
 * Created by jessicababy on 2017/4/28.
 */
/**
...
$.ajax({
    ...
    success: function (res) {
        $("#account").val(res.userInfo[0]);
        $("#phone").val(res.userInfo[1]);
        console.log(res);
    },
    error: function(e) {
        ...
        if($("#NewP").val()==''){
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    else if(res.backInfo=="password error"){
...
try{
    ...
    if(param == ""){
    	$("#tipDiv").find("p").html("请及时修改初始密码！<br>Please modify initial password！");
        $("#tipDiv").dialog("open");
    }
}catch (e){
    console.log(e);
